...
Integer noOfCopies = bookDaoImpl.getAllBookUsingCount();
Integer authors =authorDaoImpl.getAllAuthor().size();
Integer categories = categoryDaoImpl.getAllCategory().size();
Integer users = userDaoImpl.getAllUser().size();
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-left-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>total</span></div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-left-info py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-info font-weight-bold text-xs mb-1"><span>Returned books</span></div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-left-warning py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-warning font-weight-bold text-xs mb-1"><span>Rented Books</span></div>
                                            <div class="text-dark font-weight-bold h5 mb-0"><span>18</span></div>
                                        </div>
                                        <div class="col-auto"><i class="icon-notebook fa-2x text-gray-300"></i></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-left-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-primary font-weight-bold text-xs mb-1"><span>books</span></div>
                                            <div class="text-dark font-weight-bold h5 mb-0"><span><%=noOfCopies %></span></div>
                                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-left-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>authors</span></div>
                                            <div class="text-dark font-weight-bold h5 mb-0"><span><%= authors %></span></div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            ...
                                            <div class="text-dark font-weight-bold h5 mb-0"><span><%= users %></span></div>
                                        </div>
                                        <div class="col-auto"><i class="fas fa-user fa-2x text-gray-300"></i></div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-left-warning py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-warning font-weight-bold text-xs mb-1"><span>category</span></div>
                                            <div class="text-dark font-weight-bold h5 mb-0"><span><%= categories %></span></div>
                                        </div>
                                        <div class="col-auto"><i class="fas fa-align-justify fa-2x text-gray-300"></i></div>
                                    </div>
                                </div>
                            </div>
                        </div>
		...
		$(document).on('click', '#logout', function(){
			bootbox.confirm({
				...
				callback : function(result) {
					if (result == true) {
						$.ajax({
							url : '../AuthorServletAdmin?action=logout',
									type : 'Post',
									success : function(data,status) {
										if (status == 'success') {
											...
											$.bootstrapGrowl("You logged out successfully.",
													{
